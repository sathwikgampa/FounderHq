            ...
            <div className="hidden md:flex md:w-1/2 bg-[#F5F5F0] p-12 flex-col justify-between relative overflow-hidden">
                ...
                <div className="flex-1 flex flex-col justify-center max-w-lg z-10">
                    ...
                    <p className="text-lg text-slate-500 font-medium leading-relaxed max-w-md">
                        A strategic, always-on AI partner that orchestrates company success through a unified CEO Planner.
                    </p>
                </div>
                ...
                <div className="w-full max-w-[380px]">
                    ...
                    <div className="flex p-1 bg-white/5 rounded-full mb-8 relative border border-white/5">
                        <button
                            ...
                            className={`flex-1 py-2 text-sm font-semibold rounded-full transition-all duration-200 z-10 ${!isSignUp ? 'text-black bg-white shadow-sm' : 'text-slate-400 hover:text-white'
                                }`}
                        >
                            Sign In
                        </button>
                    ...
                    <div className="relative mb-6 flex items-center justify-center">
                        ...
                        <div className="relative bg-[#141414] px-4">
                            <span className="text-[10px] uppercase font-bold tracking-widest text-slate-500">Or with Email</span>
                        </div>
                    </div>
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className={`w-full bg-white/5 border ${error && isSignUp && !name.trim() ? 'border-red-500/50' : 'border-white/10'
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full bg-white/5 border ${error && error.includes('email') ? 'border-red-500/50' : 'border-white/10'
                                        } focus:border-[#7C5CFF] rounded-xl py-3 pl-10 pr-4 text-sm text-white placeholder-slate-600 focus:outline-none focus:ring-1 focus:ring-[#7C5CFF]/50 transition-all`}
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full bg-white/5 border ${error && (error.includes('password') || error.includes('match')) ? 'border-red-500/50' : 'border-white/10'
                            ...
                            <div className="space-y-1.5 pt-1">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className={`w-full bg-white/5 border ${error && error.includes('match') ? 'border-red-500/50' : 'border-white/10'
                                            } focus:border-[#7C5CFF] rounded-xl py-3 pl-10 pr-10 text-sm text-white placeholder-slate-600 focus:outline-none focus:ring-1 focus:ring-[#7C5CFF]/50 transition-all`}
                    ...
                    <div className="mt-20">
                        <div className="flex items-center justify-center gap-3 text-xs font-medium text-slate-600">
                            <Link href="/" className="hover:text-slate-400 transition-colors">Back to FounderHQ</Link>
                            <span>•</span>
