    ...
    <div className="w-full mt-12 mb-8">
      <div className="glass-card p-6 flex flex-col gap-4">
        <div className="flex flex-col md:flex-row items-center gap-4 w-full">
          ...
          <button className="w-full md:w-auto px-8 py-3.5 bg-primary text-primary-foreground font-medium rounded-xl hover:bg-primary/90 transition-colors shadow-sm whitespace-nowrap">
            Ask
          </button>
        </div>
